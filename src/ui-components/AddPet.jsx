...
export default function AddPet(props) {
  ...
  const [
    textFieldThreeFourFiveSevenTwoSixEightZeroValue,
    setTextFieldThreeFourFiveSevenTwoSixEightZeroValue,
  ] = useStateMutationAction("");
  const [
    textFieldThreeFourFiveSevenTwoSixNineFourValue,
    setTextFieldThreeFourFiveSevenTwoSixNineFourValue,
  ] = useStateMutationAction("");
  const [
    textFieldThreeFourFiveSevenTwoSixEightSevenValue,
    setTextFieldThreeFourFiveSevenTwoSixEightSevenValue,
  ] = useStateMutationAction("");
  const saveButtonOnClick = useDataStoreCreateAction({
    fields: {
      ...
      about: textFieldThreeFourFiveSevenTwoSixEightZeroValue,
      image: textFieldThreeFourFiveSevenTwoSixNineFourValue,
      color: textFieldThreeFourFiveSevenTwoSixEightSevenValue,
    },
    model: Pet,
    schema: schema,
  });
  const updateButtonOnClick = useDataStoreUpdateAction({
    fields: {
      ...
      breed: textFieldTwoNineSevenSixSixNineTwoFourValue,
      about: textFieldThreeFourFiveSevenTwoSixEightZeroValue,
      image: textFieldThreeFourFiveSevenTwoSixEightSevenValue,
      color: textFieldThreeFourFiveSevenTwoSixEightSevenValue,
    },
    id: pet?.id,
    model: Pet,
      ...
      >
        ...
        >
          <Text
            ...
            {...getOverrideProps(overrides, "Add new Pet")}
          ></Text>
          <Flex
            gap="10px"
            width="fit-content"
        ...
        >
          ...
          <TextField
            ...
            padding="0px 0px 0px 0px"
            label="About"
            placeholder="Vute, funny"
            size="default"
            isDisabled={false}
            labelHidden={false}
            variation="default"
            value={textFieldThreeFourFiveSevenTwoSixEightZeroValue}
            onChange={(event) => {
              setTextFieldThreeFourFiveSevenTwoSixEightZeroValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField34572680")}
          ></TextField>
          <TextField
            display="flex"
            gap="8px"
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeFourFiveSevenTwoSixEightSevenValue}
            onChange={(event) => {
              setTextFieldThreeFourFiveSevenTwoSixEightSevenValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField34572687")}
          ></TextField>
          <TextField
            display="flex"
            gap="8px"
            ...
            labelHidden={false}
            variation="default"
            value={textFieldThreeFourFiveSevenTwoSixNineFourValue}
            onChange={(event) => {
              setTextFieldThreeFourFiveSevenTwoSixNineFourValue(
                event.target.value
              );
            }}
            {...getOverrideProps(overrides, "TextField34572694")}
          ></TextField>
        </Flex>
        <Divider
          height="1px"
